...
(function(factory) {
   ...
   ********************/
        ...
        _setFlag: function(countryCode) {
            ...
            var titleCountry = titlec[0].split(' (');
            document.getElementById('country').value = titleCountry[0];
            document.getElementById('countryCode').value = countryCode;
            document.getElementById('phoneCode').value = titlec[1];
        ...
        _updatePlaceholder: function() {
            ...
            if (window.intlTelInputUtils && shouldSetPlaceholder) {
                ...
                // document.getElementById('phone').attr("placeholder", placeholder);
                var selectedTextarea = $('#phone')[0];
                selectedTextarea.placeholder = placeholder;
            }
        },
